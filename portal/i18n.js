...
var AR = {
  ...
  /* ---- toast messages ---- */
  "Assignment submitted!": "تم إرسال الواجب!",
  "Course created!": "تم إنشاء الدورة!",
  "Course updated!": "تم تحديث الدورة!",
  "Material uploaded": "تم رفع المادة",
  "Material removed": "تمت إزالة المادة",
  "Attendance saved": "تم حفظ الحضور",
  "All marked present": "تم تعليم الجميع حاضرين",
  "Session cancelled": "تم إلغاء الجلسة",
  "Session scheduled": "تمت جدولة الجلسة",
  "Certificate revoked": "تم إلغاء الشهادة",
  "Changes saved!": "تم حفظ التغييرات!",
  "Password updated — signing you in…": "تم تحديث كلمة المرور — جارٍ تسجيل دخولك…",
  "Enrolled! Loading your course…": "تم التسجيل! جارٍ تحميل دورتك…",
  "Enter a score first": "أدخل الدرجة أولًا",
  "Choose a file first": "اختر ملفًا أولًا",
  "Choose the certificate file first": "اختر ملف الشهادة أولًا",
  "Choose a meeting platform first": "اختر منصة الاجتماع أولًا",
  "Give the course a title first": "أعطِ الدورة عنوانًا أولًا",
  "No student selected": "لم يتم اختيار طالب",
  "No students to mark": "لا يوجد طلاب للتعليم",
  "No file was attached to this submission": "لم يُرفق أي ملف بهذا التسليم",
  "No meeting link has been added for this session yet": "لم يُضف رابط اجتماع لهذه الجلسة بعد",
  "Schedule a session for this course first": "جدول جلسة لهذه الدورة أولًا",
  "File is larger than 50 MB": "حجم الملف أكبر من 50 ميجابايت",
  "File is larger than 20 MB": "حجم الملف أكبر من 20 ميجابايت",
  "Screenshots are not permitted.": "لقطات الشاشة غير مسموح بها.",
  "Saving and printing are disabled for course materials": "الحفظ والطباعة معطّلان لمواد الدورة",
  "Could not load live data — showing demo data": "تعذّر تحميل البيانات المباشرة — عرض بيانات تجريبية",
  "Attachment opens in the protected viewer": "يُفتح المرفق في العارض المحمي",
  "Grade saved for": "تم حفظ الدرجة لـ",
  "Session scheduled on": "تمت جدولة الجلسة على",
  "Session scheduled — add the meeting link before it starts": "تمت الجدولة — أضف رابط الاجتماع قبل بدئها",
  "Certificate issued — code": "تم إصدار الشهادة — الرمز",

  /* ---- confirm dialogs ---- */
  "Reject the instructor request from": "رفض طلب المدرّب من",
  "They will keep a student account.": "سيحتفظون بحساب طالب.",
  "Revoke the certificate for": "إلغاء شهادة",
  "The file is deleted and this code will no longer verify.": "سيُحذف الملف ولن يعمل هذا الرمز للتحقق.",
  "Remove this material? Students will lose access to it.": "إزالة هذه المادة؟ سيفقد الطلاب الوصول إليها.",
  "You are about to permanently delete:": "أنت على وشك حذف ما يلي نهائيًا:",
  "assignment(s) — along with every student submission and grade for them": "واجب(ات) — مع كل تسليمات الطلاب ودرجاتهم لها",
  "lesson(s) — along with students' completion progress": "درس (دروس) — مع تقدّم إنجاز الطلاب",
  "This cannot be undone. Continue?": "لا يمكن التراجع عن هذا. هل تريد المتابعة؟",
